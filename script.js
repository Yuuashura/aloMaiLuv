function initengahan(){
  ...
  function tombol(){wallpaper.style="transform: scale(1);";Tombol.style="opacity:1;transform: scale(1);";if(fungsi==2){By.innerHTML="❤️Balas"}}
  ...
  afterComplete: function(){
    pesan5.innerHTML=vketik5 + " :3";setTimeout(aktipesan6,800);
  },}).go();
  }
  ...
  async function inipesan(){
    var {isConfirmed : nam} = await swals.fire({
           title: 'Aku mau nyampaiin hal penting..',showCancelButton : false, confirmButtonText :'Lanjut',
          //  cencelButtonText : 'Harus Lanjut',
          });
          if(nama){
            window.nama = nama;
            vketikhalo="Halo, My Love " + nama + " ✨✨✨";
            mulainama();
          }
        }
